...
export const DEFAULT_INGREDIENTS: Ingredient[] = [
  // ── CARBS / BASE (alphabetical; suggestedFor narrows by meal type) ──
  {
    id: 'basmati-rice',
    name: 'Basmati Rice',
    category: 'carb',
    ...
    perishable: false,
    suggestedFor: ['bowl', 'stir-fry', 'curry'],
  },
  {
    id: 'brown-rice',
    name: 'Brown Rice',
  ...
  },
  {
    ...
    calories: 180,
    serving: '¼ cup dry',
    packageInfo: { label: '8.8 oz box', servingsPerPackage: 5 },
    flavorTags: ['mediterranean', 'middle-eastern', 'neutral'],
    perishable: false,
    suggestedFor: ['bowl', 'soup'],
  },
  {
    id: 'jasmine-rice',
    name: 'Jasmine Rice',
  ...
  },
  {
    ...
    calories: 100,
    serving: '¼ cup',
    packageInfo: { label: '11 oz bottle', servingsPerPackage: 5 },
